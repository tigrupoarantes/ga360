-- Função que retorna funcionários com Verba Indenizatória e/ou Adiantamento para uma competência
-- Lê diretamente de payroll_verba_pivot (já sincronizado via card Verbas)
-- Agrega as duas linhas (verba + adiantamento) por CPF em uma única chamada
