-- Captura automática de histórico (SCD2) para mudanças de atributos de funcionários.
-- Garante consistência mesmo quando atualizações ocorrem por diferentes rotas (sync, admin, etc.).
